...
define i64 @main() {
entry:
  %call = call i64 @benchmark()
  ret i64 0
}

define i64 @benchmark() {
entry:
...
entry:
  ...
  %string_ptr = alloca i8*, align 8
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @string.4, i32 0, i32 0), i8** %string_ptr, align 8
