...
@string.4 = private unnamed_addr constant [12 x i8] c"min = %lli\0A\00", align 1
...
; Function Attrs: nofree nounwind
define i64 @list_demo() local_unnamed_addr #0 {
entry:
  ...
  %call15 = tail call i64 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @string, i64 0, i64 0), i64 %call14)
  ...
  %call24 = tail call i64 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @string.1, i64 0, i64 0), i64 %call23)
  ...
  %call37 = tail call i64 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @string.2, i64 0, i64 0), i64 %call36)
  ...
  %call45 = tail call i64 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @string.3, i64 0, i64 0), i64 %call44)
  ret i64 0
}
...
define noalias %List* @prepend(i64 %x, %List* %xs) local_unnamed_addr #2 {
entry:
  %malloccall = tail call dereferenceable_or_null(24) i8* @malloc(i32 24)
  %gadt = bitcast i8* %malloccall to %List*
  %tag_ptr = getelementptr inbounds %List, %List* %gadt, i64 0, i32 0
...
; Function Attrs: mustprogress nofree nounwind willreturn
define %List* @pop(%List* nocapture readonly %xs) local_unnamed_addr #2 {
entry:
...
define i64 @is_empty(%List* nocapture readonly %l) local_unnamed_addr #3 {
entry:
...
; Function Attrs: mustprogress nofree nounwind willreturn
define noalias %Option* @head(%List* nocapture readonly %l) local_unnamed_addr #2 {
entry:
...
; Function Attrs: mustprogress nofree nounwind willreturn
define %List* @tail(%List* nocapture readonly %l) local_unnamed_addr #2 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i64 @unwrap_or_default(%Option* nocapture readonly %x) local_unnamed_addr #3 {
entry:
...
; Function Attrs: nounwind
define i64 @bintree_demo() local_unnamed_addr #1 {
entry:
  ...
  %call14 = tail call i64 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @string.4, i64 0, i64 0), i64 %call13)
  %call16 = tail call i64 @free_tree(%BinTree* %call10)
  ret i64 0
}

; Function Attrs: nounwind
define i64 @free_tree(%BinTree* nocapture %root) local_unnamed_addr #1 {
entry:
...
; Function Attrs: mustprogress nofree nounwind willreturn
define %BinTree* @left(%BinTree* nocapture readonly %root) local_unnamed_addr #2 {
entry:
...
; Function Attrs: mustprogress nofree nounwind willreturn
define %BinTree* @right(%BinTree* nocapture readonly %root) local_unnamed_addr #2 {
entry:
  %tag_ptr8 = getelementptr inbounds %BinTree, %BinTree* %root, i64 0, i32 0
  %tag = load i64, i64* %tag_ptr8, align 4
  %cond = icmp eq i64 %tag, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i64 @get_value(%BinTree* nocapture readonly %root) local_unnamed_addr #3 {
entry:
  %tag_ptr = getelementptr inbounds %BinTree, %BinTree* %root, i64 0, i32 0
  %tag = load i64, i64* %tag_ptr, align 4
  %cond = icmp eq i64 %tag, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i64 @has_left(%BinTree* nocapture readonly %root) local_unnamed_addr #3 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i64 @has_right(%BinTree* nocapture readonly %root) local_unnamed_addr #3 {
entry:
  %tag_ptr5 = getelementptr inbounds %BinTree, %BinTree* %root, i64 0, i32 0
  %tag6 = load i64, i64* %tag_ptr5, align 4
  %cond7 = icmp eq i64 %tag6, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly willreturn
define i64 @is_leaf(%BinTree* nocapture readonly %root) local_unnamed_addr #3 {
entry:
