...
entry:
  ...
  store i64 1, i64* %tag_ptr6, align 4
  ...
  store i64 1, i64* %tag_ptr11, align 4
  ...
  store i64 1, i64* %tag_ptr24, align 4
  %temp_inner_ptr25 = getelementptr inbounds %Enum, %Enum* %gadt23, i32 0, i32 1
  %param26 = getelementptr inbounds %constructor_C, %constructor_C* %temp_inner_ptr25, i32 0, i32 0
  %temp_inner_ptr27 = getelementptr inbounds %Enum, %Enum* %gadt5, i32 0, i32 1
  %tag28 = getelementptr inbounds %Enum, %Enum* %gadt5, i32 0, i32 0
  %member_access29 = getelementptr inbounds %constructor_C, %constructor_C* %temp_inner_ptr27, i32 0, i32 0
  %load30 = load i64, i64* %member_access29, align 4
  store i64 %load30, i64* %param26, align 4
  %param31 = getelementptr inbounds %constructor_C, %constructor_C* %temp_inner_ptr25, i32 0, i32 1
  store i64 100, i64* %param31, align 4
...
entry:
  ...
  store i64 1, i64* %tag_ptr13, align 4
...
entry:
  ...
  %temp_inner_ptr10 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr10, i32 0, i32 1
  %temp_inner_ptr11 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag12 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access13 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr11, i32 0, i32 1
  %load14 = load %Loop*, %Loop** %member_access13, align 8
  store %Loop* %load14, %Loop** %member_access, align 8
  %temp_inner_ptr15 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag16 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access17 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr15, i32 0, i32 1
  %load18 = load %Loop*, %Loop** %member_access17, align 8
  store %Loop* %load18, %Loop** %member_access, align 8
  %temp_inner_ptr19 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag20 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access21 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr19, i32 0, i32 1
  %load22 = load %Loop*, %Loop** %member_access21, align 8
  store %Loop* %load22, %Loop** %member_access, align 8
  %temp_inner_ptr23 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag24 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access25 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr23, i32 0, i32 1
  %load26 = load %Loop*, %Loop** %member_access25, align 8
  store %Loop* %load26, %Loop** %member_access, align 8
  %temp_inner_ptr27 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 1
  %tag28 = getelementptr inbounds %Loop, %Loop* %gadt, i32 0, i32 0
  %member_access29 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr27, i32 0, i32 1
  %load30 = load %Loop*, %Loop** %member_access29, align 8
  store %Loop* %load30, %Loop** %member_access, align 8
  %deref = load %Loop*, %Loop** %member_access, align 8
  %temp_inner_ptr31 = getelementptr inbounds %Loop, %Loop* %deref, i32 0, i32 1
  %tag32 = getelementptr inbounds %Loop, %Loop* %deref, i32 0, i32 0
  %member_access33 = getelementptr inbounds %constructor_Loop, %constructor_Loop* %temp_inner_ptr31, i32 0, i32 0
  %load34 = load i64, i64* %member_access33, align 4
  ret i64 %load34
}
