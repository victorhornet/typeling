...
// sha3: 042bf373e7d8203ed0a5b430fe1f5e4856914f577935a71a449e0942a06f748f
use std::str::FromStr;
use crate::calculator::{ast::{Expr, OpCode}, Calculator6Error};
...
mod __parse__Expr {
    ...
    impl ExprParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Box<Expr>, __lalrpop_util::ParseError<usize, Token<'input>, Calculator6Error>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<Box<Expr>,__lalrpop_util::ParseError<usize, Token<'input>, Calculator6Error>>>
    {
...
) -> Result<i32,__lalrpop_util::ParseError<usize,Token<'input>,Calculator6Error>>
{
    i32::from_str(__0).map_err(|_| ParseError::User {
...
{
    fn to_triple(value: Self) -> Result<(usize,Token<'input>,usize), __lalrpop_util::ParseError<usize, Token<'input>, Calculator6Error>>;
}
...
impl<'input, > __ToTriple<'input, > for Result<(usize, Token<'input>, usize), Calculator6Error>
{
    fn to_triple(value: Self) -> Result<(usize,Token<'input>,usize), __lalrpop_util::ParseError<usize, Token<'input>, Calculator6Error>> {
        match value {
            Ok(v) => Ok(v),
