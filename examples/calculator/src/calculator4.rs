...
// sha3: 997684174d646ad2f68320b8b56fc7b303412a1e167632b39ef9097ce8769862
use std::str::FromStr;
...
mod __parse__Expr {
    ...
    {
        // Factor = Tier<FactorOp, Term> => ActionFn(2);
        let __sym0 = __pop_Variant1(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
